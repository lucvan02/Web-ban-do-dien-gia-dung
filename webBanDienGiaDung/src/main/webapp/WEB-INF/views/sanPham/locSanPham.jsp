...
<link rel="stylesheet" href='<c:url value="/assets/css/loai.css"/>' />
</head>
<body>
	<!-- HEADER -->
	<div id="header">
...
<%-- <div class="content-part width-page">
			<div class="part-body">
			<c:forEach var="sanPham" items="${productList}" begin="0" end="5">
				<div class="list-item">
        ...
        <div class="col">
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="card">
                        <a href="sanpham/${sanPham.maSP}.htm">
                        <img class="card-img-top" src="${sanPham.hinhAnhDaiDien}" alt="Card image cap">
                        </a>
                        <div class="card-body">
                            <h4 class="card-title">${sanPham.tenSanPham}</h4>
                            <div class="row">
                                <div class="col">
                                    <p class="btn btn-danger btn-block">${sanPham.donGia}</p>
                                </div>
                                <div class="col">
