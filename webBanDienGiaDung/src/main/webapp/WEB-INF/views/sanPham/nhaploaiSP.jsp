...
<section class="">
  <div class="container width=page" style="padding:50px 50px;">
    <div class="row">
      <!-- sidebar -->
      <div class="col-lg-3"  >
      ...
      <div class="col-lg-9 " >     
        ...
        <c:forEach var="sanPham" items="${categoryList}" >   
            ...
            <a class="item" href="sanpham/${sanPham.maSP}.htm"> <img
              class="card-img-top anhsp" src="${sanPham.hinhAnhDaiDien}" />
              </a>
                <div class="card-body d-flex flex-column">
                <div class= "pb-0 text-center " >
					<h6 class=" tenSanPham">${sanPham.tenSanPham}</h6>
						<span class="card-title" style="color:red;"><fmt:formatNumber value="${sanPham.donGia}" pattern="#,##0" />đ</span>							
                </div>
